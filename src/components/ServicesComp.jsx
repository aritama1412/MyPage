        ...
        <Container>
            <Row className='mb-5'>
                <Col >
                    ...
                    <p className="text-center" data-aos="fade-up" data-aos-delay="400">Cupidatat dolor voluptate occaecat amet elit fugiat qui occaecat consequat.</p>
                </Col>
            </Row>
            <Row className='row-cols-lg-3 row-cols-md-2 row-cols-1 justify-content-center'>
                <Col className='text-center py-5 px-3 border' data-aos="fade-right" data-aos-delay="800">
                ...
                <Col className='text-center py-5 px-3 border' data-aos="fade-up" data-aos-delay="800">
                ...
                <Col className='text-center py-5 px-3 border' data-aos="fade-left" data-aos-delay="800">
